...
final class FindSiteResponse
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            sites: isset($data['sites']) && is_array($data['sites']) ? array_map(fn(array $r) => \Ux2Dev\Speedy\Dto\Model\Site::fromArray($r), $data['sites']) : null,
        );
    }
}