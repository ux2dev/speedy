...
final class SecondaryShipmentsResponse
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            shipments: isset($data['shipments']) && is_array($data['shipments']) ? array_map(fn(array $r) => \Ux2Dev\Speedy\Dto\Model\SecondaryShipment::fromArray($r), $data['shipments']) : null,
        );
    }
}