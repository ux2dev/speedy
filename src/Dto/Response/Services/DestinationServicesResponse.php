...
final class DestinationServicesResponse
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            services: isset($data['services']) && is_array($data['services']) ? array_map(fn(array $r) => \Ux2Dev\Speedy\Dto\Model\ExtendedCourierService::fromArray($r), $data['services']) : null,
        );
    }
}