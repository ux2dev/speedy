...
final class Address
{
    public function __construct(
        ...
        public readonly ?string $fullAddressString = null,
        public readonly ?string $siteAddressString = null,
        public readonly ?string $localAddressString = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            x: $data['x'] ?? null,
            y: $data['y'] ?? null,
            fullAddressString: $data['fullAddressString'] ?? null,
            siteAddressString: $data['siteAddressString'] ?? null,
            localAddressString: $data['localAddressString'] ?? null,
        );
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->fullAddressString !== null) $out['fullAddressString'] = $this->fullAddressString;
        if ($this->siteAddressString !== null) $out['siteAddressString'] = $this->siteAddressString;
        if ($this->localAddressString !== null) $out['localAddressString'] = $this->localAddressString;
        return $out;
    }
}